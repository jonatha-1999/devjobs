    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @can('create', App\Models\vacante::class )
                <div class="relative">
                    <a class="text-ms text-white items-center flex flex-col justify-center mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full" href="{{ route('notificaciones') }}">

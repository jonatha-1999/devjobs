<div class="p-10">
    ...
    <div class="md:grid md:grid-cols-6 bg-gray-50 p-4 my-10 gap-6">
    ...
    <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
        <p>
            ¿Desea aplicar a esta vacante? <a class="font-bold text-indigo-600" href="{{route('register')}}">Obtenga una cuenta y aplica a esta y otras vacantes</a>
        </p>
    </div>
